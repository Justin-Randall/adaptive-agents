...
6. After approval:
   - Create a directory `planning/closed/PL-YYYYMMDD-descriptive-slug/`.
   - Save the current SDD-formatted `ACTIVE.md` as `planning/closed/PL-YYYYMMDD-descriptive-slug/PL-YYYYMMDD.sdd.md`.
   - If the plan was activated from a backlog item, copy the original backlog entry into the same directory as `planning/closed/PL-YYYYMMDD-descriptive-slug/PL-YYYYMMDD.backlog.md`.
