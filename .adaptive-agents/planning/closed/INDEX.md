...
| PL-20260710 | [OpenCode Installer Support](PL-20260710-opencode-installer-support/PL-20260710.sdd.md) ([backlog](PL-20260710-opencode-installer-support/PL-20260710.backlog.md)) | Completed | OpenCode installer (`scripts/install-opencode.sh`), 6 custom slash commands, automated test suite (22/22), global AGENTS.md, repository checker validation, all verified via automated tests and manual dogfood with `ADAPTIVE_AGENTS_GLOBAL_LOADED` confirmation. |
