...
- Origin: Backlog ([PL-20260711-claude-code-support.backlog.md](PL-20260711-claude-code-support.backlog.md))
...
- [Backlog: Claude Code Support](PL-20260711-claude-code-support.backlog.md) — original backlog entry (archived alongside)
