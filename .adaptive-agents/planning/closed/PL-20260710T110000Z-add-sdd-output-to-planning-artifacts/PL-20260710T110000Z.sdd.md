...
- Plan IDs use ISO 8601 UTC timestamp format (`PL-YYYYMMDDTHHMMSSZ`) for collision resistance across multiple contributors. Legacy `PL-####` format is still validator-accepted for backward compatibility.
